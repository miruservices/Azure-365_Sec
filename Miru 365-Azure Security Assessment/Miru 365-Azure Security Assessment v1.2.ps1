<# 
. Name:
        Miru 365-Azure Security Assessment v1.2
...
function Prerequests {
    ...
    Write-Host " INFO: All assesment results will be saved in a report Excel file. All raw data will be saved in separate files in raw folder in session folder at this running directory."
